...
如果是内网环境，你也可以通过 [离线安装包]([https://community.fit2cloud.com//products/cordys-crm/downloads](https://community.fit2cloud.com/#/products/cordys-crm/information)) 部署 Cordys CRM。
